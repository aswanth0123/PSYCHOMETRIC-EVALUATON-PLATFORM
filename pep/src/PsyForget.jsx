...
export default function PsychologistForgetPassword() {
    ...
    const handleEmailSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await fetch("http://localhost:5000/api/psychologist/verify-email", {
                method: "POST",
    ...
    const handlePasswordReset = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await fetch("http://localhost:5000/api/psychologist/reset-password", {
                method: "POST",
                headers: { "Content-Type": "application/json" },

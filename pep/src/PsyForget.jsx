...
export default function ForgetPassword() {
    ...
    const sendOTP = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.post("http://localhost:5000/api/psychologist/send-otp", { email });
    ...
    const verifyOTP = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.post("http://localhost:5000/api/psychologist/verify-otp", { email, otp });
            setMessage(res.data.message);
            setStep(3);
        } catch (err) {
    ...
    const handlePasswordReset = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.post("http://localhost:5000/api/psychologist/reset-password", { email, newPassword });
            setMessage(res.data.message);
